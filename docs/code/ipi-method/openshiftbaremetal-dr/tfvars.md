# DR Secondary — terraform.tfvars

Example variable values for the DR Secondary workload cluster. Uses the DR site network
(`10.143.41.0/24`) with non-overlapping CIDRs for Submariner connectivity.
