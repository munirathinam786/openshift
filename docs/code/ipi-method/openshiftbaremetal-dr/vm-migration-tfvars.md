# IPI DR — vm-migration.tfvars

Variable definitions for VM Migration using the Migration Toolkit for Virtualization (MTV / Forklift) on the DR Secondary cluster.

!!! info "File Location"
    `ipi-method/openshiftbaremetal-dr/vm-migration.tfvars`
...
```hcl
--8<-- "ipi-method/openshiftbaremetal-dr/vm-migration.tfvars"
```
