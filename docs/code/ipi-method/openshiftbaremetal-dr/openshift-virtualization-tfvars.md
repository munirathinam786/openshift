# IPI DR — openshift-virtualization.tfvars

Variable definitions for OpenShift Virtualization (KubeVirt / CNV) deployment on the DR Secondary cluster.

!!! info "File Location"
    `ipi-method/openshiftbaremetal-dr/openshift-virtualization.tfvars`
...
```hcl
--8<-- "ipi-method/openshiftbaremetal-dr/openshift-virtualization.tfvars"
```
