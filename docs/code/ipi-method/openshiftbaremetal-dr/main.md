# DR Secondary — main.tf

Main orchestration file for the DR Secondary workload cluster (`openshiftbaremetal-dr/`).
...
???+ note "Draw.io Source: Ipi Dr Dep Chain"
    [:material-download: Download .drawio file](../../../diagrams/code/08-ipi-dr-dep-chain.drawio){ .md-button } — Open in [draw.io](https://app.diagrams.net) for interactive editing.
