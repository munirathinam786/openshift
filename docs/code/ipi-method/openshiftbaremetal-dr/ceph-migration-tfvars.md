# IPI DR Secondary — ceph-migration.tfvars

Configuration for Ceph/ODF storage migration from DR Secondary to another cluster using RBD mirroring.
...
| `ceph_migration_source_cluster_name` | string | `dr-secondary` | Source cluster name |
| `ceph_migration_source_cluster_kubeconfig` | string | `/opt/ocp/dr-secondary/auth/kubeconfig` | Source kubeconfig path |
| `ceph_migration_destination_cluster_name` | string | `dc-primary` | Destination cluster name |
| `ceph_migration_destination_cluster_kubeconfig` | string | `/opt/ocp/dc-primary/auth/kubeconfig` | Destination kubeconfig path |
...
```hcl
# =============================================================================
# Ceph Migration — Variable Values (DR Secondary)
...
# ---- Source Cluster ----
ceph_migration_source_cluster_name       = "dr-secondary"
ceph_migration_source_cluster_kubeconfig = "/opt/ocp/dr-secondary/auth/kubeconfig"

# ---- Destination Cluster ----
ceph_migration_destination_cluster_name       = "dc-primary"
ceph_migration_destination_cluster_kubeconfig = "/opt/ocp/dc-primary/auth/kubeconfig"
