# Agent Builder Factory — outputs.tf (IPI DR Secondary)

Terraform outputs for the Agent Builder Factory platform on the **IPI DR Secondary** environment. Provides URLs for all deployed services.
