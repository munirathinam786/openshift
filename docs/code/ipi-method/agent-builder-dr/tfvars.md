# Agent Builder Factory — terraform.tfvars (IPI DR Secondary)

Default variable values for the Agent Builder Factory deployment on the **IPI DR Secondary** environment. Customize for your environment — replace all `REPLACE_*` placeholders with actual secrets.
