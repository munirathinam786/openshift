# Agent Builder Factory — main.tf (IPI DR Secondary)

Main orchestration file for the Agent Builder Factory platform (`ipi-method/agent-builder-dr/`).
...
!!! info "Environment: IPI DR Secondary"
    **Cluster:** `ocp-ai-dr` | **Bastion:** `10.143.41.10` | **Domain:** `dr.example.com`
...
# Agent Builder Factory — DR Secondary Deployment on OpenShift Baremetal (IPI)
