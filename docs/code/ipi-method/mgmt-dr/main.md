# Management DR — main.tf

Main orchestration for the Management DR cluster (`mgmt-dr/`).
...
# --- Red Hat ACM (Standby — can be promoted to hub) ---
module "acm" {
...
# --- ACS SecuredCluster (sensor + collector, Central is in mgmt-dc) ---
module "acs" {
