# Management DR — variables.tf

Variable definitions for the Management DR cluster. Similar to Mgmt DC but with
`acs_central_endpoint` for pointing SecuredCluster to the Central in mgmt-dc.
