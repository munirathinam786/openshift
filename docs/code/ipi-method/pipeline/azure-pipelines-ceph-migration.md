# azure-pipelines-ceph-migration.yml (Ceph Migration)

Azure DevOps pipeline for Ceph/ODF storage migration between clusters or datacenters.
See the [Ceph Migration Pipeline Documentation](../../../pipeline/terraform-ceph-migration-pipeline.md) for full details.

!!! info "Location"
    `ipi-method/azure-pipelines-ceph-migration.yml`
