# IPI — Azure DevOps Pipeline — azure-pipelines-mtc.yml

Pipeline for migrating containerized workloads between OpenShift clusters using
the Migration Toolkit for Containers (MTC / Crane).

!!! info "Pipeline Location"
    Source file: `ipi-method/azure-pipelines-mtc.yml`
...
```yaml
--8<-- "ipi-method/azure-pipelines-mtc.yml"
```
