# IPI — vm-migration.tfvars

Variable definitions for VM Migration using the Migration Toolkit for Virtualization (MTV / Forklift).

!!! info "File Locations"
    - DC Primary: `ipi-method/openshiftbaremetal/vm-migration.tfvars`
    - DR Secondary: `ipi-method/openshiftbaremetal-dr/vm-migration.tfvars`
...
```hcl
--8<-- "ipi-method/openshiftbaremetal/vm-migration.tfvars"
```
