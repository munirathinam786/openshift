...
???+ note "Draw.io Source: Ipi Dc Dep Chain"
    [:material-download: Download .drawio file](../../../diagrams/code/07-ipi-dc-dep-chain.drawio){ .md-button } — Open in [draw.io](https://app.diagrams.net) for interactive editing.

## Source Code

```hcl
# =============================================================================
# OpenShift Baremetal + OpenShift AI — Main Orchestration
# =============================================================================
