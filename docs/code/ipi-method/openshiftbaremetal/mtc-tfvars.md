...
Variable definitions for MTC (Migration Toolkit for Containers) — migrating containerized workloads between OpenShift clusters.

!!! info "File Locations"
    - DC Primary: `ipi-method/openshiftbaremetal/mtc.tfvars`
    - DR Secondary: `ipi-method/openshiftbaremetal-dr/mtc.tfvars`
...
```hcl
--8<-- "ipi-method/openshiftbaremetal/mtc.tfvars"
```
