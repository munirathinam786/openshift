# Management DC — variables.tf

Variable definitions for the Management DC cluster. Includes cluster basics, networking,
nodes, ODF, ACM Hub, ACS Central, and Quay Enterprise variables.

## Source Code

```hcl
# =============================================================================
# Management Cluster DC — Variables
# =============================================================================
...
# ---- ACM ----
variable "enable_acm" {
  description = "Deploy Red Hat Advanced Cluster Management hub"
  type        = bool
  default     = true
}
...
# ---- ACS ----
variable "enable_acs" {
  description = "Deploy Red Hat Advanced Cluster Security (Central + SecuredCluster)"
  type        = bool
  default     = true
}
...
variable "enable_quay_enterprise" {
  description = "Deploy Red Hat Quay enterprise registry on-cluster"
  type        = bool
  default     = true
}
