# Management DC (UPI) — variables.tf

Variable definitions for the UPI Management DC cluster. Includes UPI-specific variables
(install_dir, rhcos URLs, boot_method, ignition) plus ACM Hub, ACS Central, and Quay Enterprise.
