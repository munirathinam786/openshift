# Management DC (UPI) — main.tf

Main orchestration for the UPI Management DC cluster (`upi-method/mgmt-dc/`).
Deploys OCP on bare metal using UPI with ACM Hub, ACS Central + SecuredCluster,
Quay Enterprise, ODF, and MetalLB.

## Source Code

```hcl
# =============================================================================
# Management Cluster DC — UPI Method
# ACM Hub + ACS Central + Quay Enterprise (No GPU/AI operators)
...
module "acm" {
  ...
  depends_on = [module.cluster_complete, module.odf_operator]
}

# --- Day-2: ACS (Central + SecuredCluster) ---
module "acs" {
...
# --- Day-2: Quay Enterprise Registry ---
