# UPI DR — openshift-virtualization.tfvars

Variable definitions for OpenShift Virtualization (KubeVirt / CNV) deployment on the UPI DR Secondary cluster.

!!! info "File Location"
    `upi-method/openshiftbaremetal-dr/openshift-virtualization.tfvars`
...
```hcl
--8<-- "upi-method/openshiftbaremetal-dr/openshift-virtualization.tfvars"
```
