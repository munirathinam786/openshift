# UPI DR — vm-migration.tfvars

Variable definitions for VM Migration using the Migration Toolkit for Virtualization (MTV / Forklift) on the UPI DR Secondary cluster.

!!! info "File Location"
    `upi-method/openshiftbaremetal-dr/vm-migration.tfvars`
...
```hcl
--8<-- "upi-method/openshiftbaremetal-dr/vm-migration.tfvars"
```
