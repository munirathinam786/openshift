# UPI — Azure DevOps Pipeline — azure-pipelines-vm-migration.yml

Pipeline for migrating VMs from VMware vSphere, RHV, or OpenStack to OpenShift Virtualization
using the Migration Toolkit for Virtualization (MTV / Forklift) on UPI clusters.

!!! info "Pipeline Location"
    Source file: `upi-method/azure-pipelines-vm-migration.yml`
...
```yaml
--8<-- "upi-method/azure-pipelines-vm-migration.yml"
```
