# Agent Builder Factory — Azure DevOps Pipeline (Day 1 — UPI)

Azure DevOps Pipeline for Day 1 deployment of the Agent Builder Factory platform on OpenShift Baremetal (UPI). Features 6 stages: container image build, data layer (PostgreSQL/MongoDB/Redis), infrastructure (Temporal/Ollama/LiteLLM), application services, validation, and summary.

## Source Code

```yaml
# Author: Sathishkumar Munirathinam
# Azure DevOps Pipeline — Agent Builder Factory (Day 1 Deployment — UPI)
# Deploys the complete Agent Builder platform on OpenShift Baremetal (UPI)
