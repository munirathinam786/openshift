# Agent Builder Factory — terraform.tfvars (UPI DC Primary)

Default variable values for the Agent Builder Factory deployment on the **UPI DC Primary** environment. Customize for your environment — replace all `REPLACE_*` placeholders with actual secrets.
