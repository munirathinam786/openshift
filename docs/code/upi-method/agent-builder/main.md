# Agent Builder Factory — main.tf (UPI DC Primary)

Main orchestration file for the Agent Builder Factory platform (`upi-method/agent-builder/`).
...
!!! info "Environment: UPI DC Primary"
    **Cluster:** `ocp-ai-upi` | **Bastion:** `10.142.41.10` | **Domain:** `example.com`
...
# Agent Builder Factory — Deployment on OpenShift Baremetal (UPI DC Primary)
