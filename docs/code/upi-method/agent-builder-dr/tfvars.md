# Agent Builder Factory — terraform.tfvars (UPI DR Secondary)

Default variable values for the Agent Builder Factory deployment on the **UPI DR Secondary** environment. Customize for your environment — replace all `REPLACE_*` placeholders with actual secrets.
...
# Agent Builder Factory — terraform.tfvars (UPI DR Secondary)
# Customize values below for your DR site environment
