# Agent Builder Factory — outputs.tf (UPI DR Secondary)

Terraform outputs for the Agent Builder Factory platform on the **UPI DR Secondary** environment. Provides URLs for all deployed services.
