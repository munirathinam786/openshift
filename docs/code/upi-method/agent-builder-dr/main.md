# Agent Builder Factory — main.tf (UPI DR Secondary)

Main orchestration file for the Agent Builder Factory platform (`upi-method/agent-builder-dr/`).
...
!!! info "Environment: UPI DR Secondary"
    **Cluster:** `ocp-ai-upi-dr` | **Bastion:** `10.143.41.10` | **Domain:** `dr.example.com`
