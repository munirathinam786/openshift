# UPI — Azure DevOps Pipeline — azure-pipelines-cnv.yml

Pipeline for deploying OpenShift Virtualization (KubeVirt / CNV) to UPI workload clusters.
Supports DC Primary, DR Secondary, or both clusters simultaneously.

!!! info "Pipeline Location"
    Source file: `upi-method/azure-pipelines-cnv.yml`
...
```yaml
--8<-- "upi-method/azure-pipelines-cnv.yml"
```
