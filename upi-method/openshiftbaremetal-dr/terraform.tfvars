# =============================================================================
# OpenShift Baremetal UPI DR Secondary + OpenShift AI — Variable Definitions
# Update all values below to match your DR site environment.
# =============================================================================

# ---- Cluster ----
cluster_name = "ocp-ai-upi-dr"
base_domain  = "dr.example.com"
ocp_version  = "4.20"

# ---- Networking (non-overlapping with DC Primary) ----
...
rhcos_iso_url    = "http://10.143.41.10:8080/rhcos-4.20.0-x86_64-live.x86_64.iso"
rhcos_rootfs_url = "http://10.143.41.10:8080/rhcos-4.20.0-x86_64-live-rootfs.x86_64.img"
...
bootstrap_ip  = "10.143.41.20"
bootstrap_mac = "aa:bb:cc:dd:ff:00"
...
submariner_broker_api_url      = "https://api.ocp-ai-upi.example.com:6443"
...
# ---- ODF DR Replication (DR side — peers with DC Primary) ----
enable_odf_dr               = false
odf_dr_mode                 = "regional-dr"
odf_dr_replication_schedule = "*/5 * * * *"
odf_dr_peer_cluster_name    = "ocp-ai-upi"
odf_dr_s3_endpoint          = ""
