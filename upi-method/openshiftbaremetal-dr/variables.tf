...
variable "cnv_cpu_model" {
  description = "Default CPU model for VMs"
  type        = string
  default     = "host-model"
}
...
variable "cnv_infra_node_selector" {
  description = "Node selector for infra components"
  type        = map(string)
  default     = {}
}

variable "cnv_workload_node_selector" {
  description = "Node selector for workload placement"
  type        = map(string)
  default     = {}
}
...
variable "source_provider_url" {
  description = "API URL of the source provider"
  type        = string
  default     = ""
}
...
variable "destination_provider_name" {
  description = "Name for the destination provider"
  type        = string
  default     = "host"
}
...
variable "migration_plan_namespace" {
  description = "Namespace for the migration plan"
  type        = string
...
variable "migration_type" {
  description = "Migration type: cold or warm"
  type        = string
  default     = "cold"
}
...
variable "migration_transfer_network" {
  description = "Dedicated network for disk transfer"
  type        = string
  default     = ""
}
